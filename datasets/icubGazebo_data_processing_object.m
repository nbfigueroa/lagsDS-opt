...
data = []; 
odata = [];
window_size = 551; crop_size = (window_size+1)/2; 
...
% Draw Obstacles
rectangle('Position',[-1.5 1 3 2], 'FaceColor',[.85 .85 .85]); hold on;
rectangle('Position',[2 1 3 2], 'FaceColor',[.85 .85 .85]); hold on;
