...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Option 2: Constrained Local-Dynamics Estimation, estimating \kappa %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
stability_vars.epsilon         = 0.1;      % small number for f_Q < -eps
...
stability_vars.test_grid       = 0;        % To test the minimum found
...
[A_l, b_l, A_d, b_d] = estimate_localDS(Data, A_g, att_g, fl_type, att_l, Mu, Sigma, Norm, limits, stability_vars)
